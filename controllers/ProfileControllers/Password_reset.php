...
function changePassword($database) {
    ...
    $PROFILEPSW = new Profile($database);
//checks password db
    if (!password_verify($profilePasswordOld, $PROFILEPSW->selectPassword($id)['msg'][0]['password'])) {
...
require 'views/ProfileActions/password_reset.view.php';
